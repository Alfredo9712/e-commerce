...
const AdminDash = () => {
  ...
  return (
    <>
      <Router>
        {width < 850 && (
          <Navbar bg='primary' variant='dark' style={{ width: '100vw' }}>
            <Navbar.Collapse id='navbarScroll'>
              <Nav>
                <LinkContainer to='/admin'>
                  <Nav.Link>
                    <HomeIcon style={{ marginLeft: '30px' }} />
                  </Nav.Link>
                </LinkContainer>
                <LinkContainer to='/orderHistory'>
                  <Nav.Link>
                    <ListAltIcon style={{ marginLeft: '40px' }} />
                  </Nav.Link>
                </LinkContainer>
                <LinkContainer to='/add'>
                  <Nav.Link>
                    <AddShoppingCartIcon style={{ marginLeft: '40px' }} />
                  </Nav.Link>
                </LinkContainer>

                <LinkContainer to='/update'>
                  <Nav.Link>
                    <UpdateIcon style={{ marginLeft: '40px' }} />
                  </Nav.Link>
                </LinkContainer>

                <Nav.Link onClick={signOutHandler}>
                  <ExitToAppIcon style={{ marginLeft: '40px' }} />
                </Nav.Link>
              </Nav>
            </Navbar.Collapse>
          </Navbar>
